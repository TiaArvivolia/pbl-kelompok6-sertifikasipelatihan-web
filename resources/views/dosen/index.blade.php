...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            @if ($user->id_jenis_pengguna == 1) <!-- Check if the user is a admin -->
                ...
                <a href="{{ url('/dosen/export_pdf') }}" class="btn btn-sm btn-warning mt-1">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-sm table-striped table-hover" id="table-dosen"style="width: 100%;">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Profil</th>
