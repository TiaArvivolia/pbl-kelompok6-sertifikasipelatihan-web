...
<div id="modal-master" class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <a href="{{ url('/mata_kuliah') }}" class="btn btn-warning">Kembali</a>
        </div>
    </div>
</div>
@else
<form action="{{ url('/mata_kuliah/' . $mata_kuliah->id_mata_kuliah . '/delete_ajax') }}" method="POST" id="form-delete">
    @csrf
    @method('DELETE')
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        dataMataKuliah.ajax.reload(); // Update the DataTable after deletion
                    } else {
                        $('.error-text').text('');
