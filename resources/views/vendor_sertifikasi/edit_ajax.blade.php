...
@else
<form action="{{ url('/vendor_sertifikasi/' . $vendor_sertifikasi->id_vendor_sertifikasi . '/update_ajax') }}" method="POST" id="form-edit">
    @csrf
    @method('PUT')
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="{{ $vendor_sertifikasi->nama }}" type="text" name="nama" id="nama" class="form-control" required>
