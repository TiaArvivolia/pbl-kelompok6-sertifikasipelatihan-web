<form action="{{ url('/vendor_sertifikasi/ajax') }}" method="POST" id="form-tambah-vendor-sertifikasi">
    @csrf
    <div id="modal-vendor-sertifikasi" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Vendor Sertifikasi</h5>
...
$(document).ready(function() {
    $("#form-tambah-vendor-sertifikasi").validate({
        rules: {
