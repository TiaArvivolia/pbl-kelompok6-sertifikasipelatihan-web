<form action="{{ url('/jenis_pelatihan/ajax') }}" method="POST" id="form-tambah-jenis-pelatihan">
    @csrf
...
<script>
    $(document).ready(function() {
        $("#form-tambah-jenis-pelatihan").validate({
            rules: {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            dataJenisPelatihan.ajax.reload(); // Reload the DataTable for training types
                        } else {
                            $('.error-text').text('');
