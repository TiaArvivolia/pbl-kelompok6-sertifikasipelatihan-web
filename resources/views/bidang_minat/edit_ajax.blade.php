        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="{{ $bidang_minat->kode_bidang_minat }}" type="text" name="kode_bidang_minat" id="kode_bidang_minat" class="form-control" required>
                    <small id="error-kode_bidang_minat" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Nama Bidang Minat</label>
                    <input value="{{ $bidang_minat->nama_bidang_minat }}" type="text" name="nama_bidang_minat" id="nama_bidang_minat" class="form-control" required>
...
$(document).ready(function() {
    $("#form-edit").validate({
        rules: {
            kode_bidang_minat: { required: true, minlength: 1, maxlength: 20 },
            nama_bidang_minat: { required: true, minlength: 1, maxlength: 100 }
        },
