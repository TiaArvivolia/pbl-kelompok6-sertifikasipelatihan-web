...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button onclick="modalAction('{{ url('/daftar-sertifikasi/import') }}')" class="btn btn-sm btn-info mt-1">Import Daftar Sertifikasi</button>
            <a href="{{url('/daftar-sertifikasi/export_excel')}}" class="btn btn-sm btn-primary mt-1"><i class="fa fa-file-excel"></i> Export Daftar Sertifikasi (Excel)</a>
            <a href="{{url('/daftar-sertifikasi/export_pdf')}}" class="btn btn-sm btn-warning mt-1"><i class="fa fa-file-pdf"></i> Export Daftar Sertifikasi (PDF)</a>
            <button onclick="modalAction('{{ url('daftar-sertifikasi/create_ajax') }}')" class="btn btn-sm btn-success mt-1">Tambah Daftar Sertifikasi</button>
        </div>
    </div>
    <div class="card-body">
        @if (session('success'))
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var dataMataKuliah = $('#table_daftar-sertifikasi').DataTable({
                serverSide: true,
                ajax: {
                    "url": "{{ url('daftar-sertifikasi/list') }}",
                    "dataType": "json",
                    "type": "POST"
                },
                columns: [
